...
const EVAL_FIRST = [
  ...
  {cond: c=>c.lv>=CFG.realms[9] && (c.g._jie||0)>=4, // DL_RS_4.157b：渡劫强者（原 *4 阈值 lv 恒定不达）
   texts:[
...
const EVAL_THIRD = [
  ...
  {cond: c=>c.lv>=CFG.realms[10] || c.g.endTag, texts:[
  ...
  {cond: c=>c.lv>=CFG.realms[9] && (c.g._jie||0)>=4, // DL_RS_4.157b：尾评渡劫强者（同上）
   texts:[
